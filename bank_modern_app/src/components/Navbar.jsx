...
const Navbar = () => {
  const [toggle, setToggle] = useState(false); /*Se define en el inicio el estado  */

  return (
    <nav className='w-full flex py-6 jusfity-between items-center navbar'>
      ...
      <div className="sm:hidden flex flex-1 justify-end cursor-pointer items-center">
        <img src={toggle ? close : menu} alt="menu" className="w-[28px] h-[28px] contain" onClick={() => setToggle((prev) => (!prev)) }/>
